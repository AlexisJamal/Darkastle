...
public :
	...
	/**
	@brief Restaure le terrain à son état d'origine
	*/
	...
	*/
	...
	/**
	@brief Renvoie vrai si la case est un 'c'
	*/
	...
	*/
	...
	/**
	@brief Renvoie vrai si la case (x,y) passée en paramètres est un 'T'
	*/
	...
	*/
	bool estPositionPlateformeValide(const int x, const int y) const;
    	...
    	/**
    	@brief Renvoie le caractère se trouvant en (x,y)
    	*/
    	char getXY (const int x, const int y) const;

	/**
    	@brief Change le caractère se trouvant en (x,y)
    	*/
