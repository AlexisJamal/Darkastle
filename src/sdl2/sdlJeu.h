...
private :
	...
	Image im_superJump;
	Image im_inventaire;
	Image im_dragonDroite;
	Image im_dragonGauche;
	Image im_mortVie;
	Image im_mortLave;
	Image im_plateformeMobile;
 	Image im_personnageGaucheInvincible;
	Image im_personnageDroiteInvincible;
	Image im_personnageAttaqueGaucheInvincible;
	Image im_personnageAttaqueDroiteInvincible;
	Image im_plateformeLave;
	Image im_bouton;
	Image im_vieDragon;
	Image im_barreVie;
	Image im_fondVictoire;
...
public :
    ...
    ~sdlJeu ();
    void sdlBoucle ();
    void sdlAff (unsigned int cote, unsigned int & attaque, unsigned int & testMort,unsigned int & testFondS1, unsigned int invulnerabilite, unsigned int test);
